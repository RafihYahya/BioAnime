...
const [toggle, settoggle] = useState(false)
  ...
  return (
    <div id='navbar' className=' fixed z-50 w-full h-[55px]'>
        <div className=' w-full h-full bg-[#1b1b1b] text-center shadow-lg  '>
            <div className='  max-w-[1500px] w-full h-full mx-auto flex items-center justify-between '>
                <h1 className='font-bold  text-2xl text-red-500 '><span className='text-red-400'>Bio</span>Anime</h1>
